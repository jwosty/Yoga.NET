...
//         private CppVector<Node> children_;
//
...
//         public static extern Node Create(Node* pThis);
//
...
//         public static extern Node Create(Node* pThis, [NativeTypeName("const Config *")] Config* config);
//
...
//         public static extern Node Create(Node* pThis, [NativeTypeName("facebook::yoga::Node &")] Node* node);
//
